...
<div class="row">
    <div class="col-10">
        <div class="card">
            <div class="card-body">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">lokasi add Page</h4><br></br>
                </div>

                <form method="post" action="{{ route('lokasi.store') }}" enctype="multipart/from-data" id="myForm">
                    @csrf

                <div class="row mb-3">
                    <label for="text" class="col-2 col-form-label">lokasi</label>
                    <div class="form-group col-10">
                        <input name="lokasi" class="form-control" type="text" placeholder="" id="text">
                    </div>
                </div>
